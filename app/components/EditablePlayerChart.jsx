...
import { ActionIcon, Button, Group, ScrollArea, Select, Table, Text } from "@mantine/core";
        ...
        (preferredPositions, dislikedPositions) => {
            ...
            positions.push({
                ...
                items: Object.keys(fieldingPositions).filter(
                    (position) => !preferredPositions.includes(position) && !dislikedPositions.includes(position)
                ),
            });
                                                    ...
                                                    <Table.Tr ref={provided.innerRef} {...provided.draggableProps}>
                                                        ...
                                                        {columns.map((column) => {
                                                            if (column.accessor.startsWith("inning")) {
                                                                ...
                                                                const player = playerChart.find(
                                                                    (p) => p.firstName + " " + p.lastName === row.player
                                                                );
            ...
            {managerView && (
                ...
                >
                    ...
                    <Group justify="space-between" mt="xl" grow>
                        <Button variant="outline" onClick={removePlayerHandlers.close}>
                            Cancel
                        </Button>
