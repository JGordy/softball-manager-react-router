...
export default function EventDetails({ loaderData, actionData }) {
    ...
    return (
        <>
            ...
            <DetailsCard game={game} deferredData={deferredData} season={season} team={team} />

            {!gameIsPast && <WeatherCard gameDate={gameDate} weatherPromise={weatherPromise} />}
            ...
            {managerView && (
                <DrawerContainer opened={deleteDrawerOpened} onClose={deleteDrawerHandlers.close} title="Delete Game">
