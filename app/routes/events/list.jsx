...
import { ActionIcon, Container, Menu, SegmentedControl, Tabs, Title, useComputedColorScheme } from "@mantine/core";
...
export default function EventsDetails({ loaderData }) {
    ...
    const teamFilter = teamsData?.length > 1 && (
        ...
        >
            ...
            <Menu.Dropdown bg={computedColorScheme === "light" ? "gray.1" : undefined} miw="60vw" pt="md">
    ...
    return (
        <Container>
            <UserHeader subText="Track your game history">{teamFilter}</UserHeader>
