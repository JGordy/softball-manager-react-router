...
const weatherFallback = (
    <Stack align="center">
        ...
        <Text c="dimmed" ta="center">
            Weather data is generally available starting 4 days before the scheduled game date. Please check back at a
            later time.
        </Text>
    </Stack>
);
                    ...
                    >
                        <Group justify="space-around" gap="0">
                            <Stack align="center" gap="3px" w="30%">
                                ...
                                <Text size="xl" fw={700} c={getPrecipitationChanceRating(pop).color}>
                                    {pop * 100}%
                                </Text>
                            ...
                            <Stack align="center" gap="3px" w="30%">
                                <IconNavigationFilled
                                    size={20}
                                    style={{ transform: `rotate(${wind.direction.degrees + 180}deg)` }}
                                />
                                <Text size="xl" fw={700} c={getWindSpeedRating(wind.speed.value).color}>
                            ...
                            <Stack align="center" gap="3px" w="30%">
                                ...
                                <Text size="xl" fw={700} c={getUvIndexColor(uvIndex)}>
                                    {Math.round(uvIndex)}
                                </Text>
                    ...
                    subHeading={
                        ...
                        >
                            {(weather) => {
                                ...
                                let summary;
                                if (gameDayWeather) {
                                    summary = `${Math.round(gameDayWeather.temperature.degrees)}°F / ${
                ...
                {(weather) => {
                    ...
                    return (
                        ...
                        >
                            {!gameDayWeather
                                ? weatherFallback
                                : renderWeatherDetails({ ...gameDayWeather, totalPrecipitation, rainout })}
                        </DrawerContainer>
                    );
                }}
            </DeferredLoader>
