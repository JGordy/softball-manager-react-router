...
export default function SeasonDetails({ loaderData, actionData }) {
    ...
    const openGenerateGamesModal = () =>
        openModal({
            ...
            children: <GenerateSeasonGames actionRoute={`/season/${season.$id}`} season={season} />,
        });
    ...
    const openAddGameModal = () =>
        openModal({
            ...
            children: (
                <AddSingleGame action="add-single-game" actionRoute={`/season/${season.$id}`} seasonId={season.$id} />
            ),
        });
    ...
    return (
        <Container pt="md">
            ...
            <Group mt="sm" justify="space-between">
                <Group gap="5px">
                    <IconMapPin size={18} />
                    <Text {...textProps}>{season.location || "Not specified"}</Text>
                </Group>
                ...
                <Group gap="5px">
                    ...
                    <Text {...textProps}>{`${season.signUpFee || "TBD"}/player`}</Text>
                </Group>
            </Group>
            ...
            {!hasGames && (
                <>
                    ...
                    <Button my="md" onClick={openGenerateGamesModal} fullWidth autoContrast>
