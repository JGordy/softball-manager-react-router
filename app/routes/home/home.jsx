...
import { Button, Card, Container, Group, ScrollArea, Text, Title } from "@mantine/core";
...
export function meta() {
    return [{ title: "Rocket Roster" }, { name: "description", content: "Welcome to Rocker Roster!" }];
}
...
export default function HomePage({ loaderData, actionData }) {
    ...
    return (
        <Container>
            ...
            {!teamList?.length && (
                <Button fullWidth variant="filled" mt="md" onClick={openAddTeamModal}>
