...
import { Avatar, Button, Card, Flex, Group, ScrollArea, Tabs, Text, Tooltip } from "@mantine/core";
...
export default function PlayerList({ players, managerIds, managerView, primaryColor, teamId }) {
    ...
    return (
        <>
            ...
            {managerView && (
                <Button mt="md" color={primaryColor} onClick={openAddPlayerModal} autoContrast fullWidth>
                    <IconPlus size={20} />
                    Add Player
                </Button>
            )}
