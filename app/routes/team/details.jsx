...
import { IconCalendarMonth, IconUsersGroup, IconBallBaseball } from "@tabler/icons-react";
...
export default function TeamDetails({ actionData, loaderData }) {
    ...
    const openTeamDetailsForm = () =>
        openModal({
            ...
            children: <AddTeam action="edit-team" actionRoute={`/team/${team.$id}`} buttonColor={primaryColor} />,
        });
